...
- мультфильмы
- мультсериалы
- документалки (отдельная категория)
- аниме (отдельная категория)
...
- год выпуска
- категория
- вселенная (именовая или безымянная (именуется по первому по хронологии фильму)) - nullable
- список создателей (с указанием типа - режиссёры, продюсеры etc) - nullable
- список актёров (с указанием типа - игровые, актеры озвучки etc) - nullable
