...
## Описание
Онлайн кинотеатр, основной источник медиа - торрент. Торренты качаются только локально, хостинги запрещают bittorrent (ruvds в запросе в тп разрешил торрент трафик на загрузку, но лучше не рисковать блокировой акканта).
